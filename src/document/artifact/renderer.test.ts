...
describe("DOMDocumentArtifactRenderer", () => {
    ...
    test("renders TAG_OPEN artifacts with CSS", () => {
        const renderer = new DocumentArtifactRenderer()
        const styles: Style[] = [
            { name: "max-width", value: "500px", pseudoSelector: null, mediaQuery: null }
        ]
    ...
    test("renders TAG_OPEN artifacts with pseudo-selector scoped media-query CSS", () => {
        const renderer = new DocumentArtifactRenderer()
        const styles: Style[] = [
            { name: "color", value: "blue", pseudoSelector: ":hover", mediaQuery: "@media (max-width: 600px)" }
        ]
    ...
    test("emits distinct style blocks for different CSS", () => {
        ...
        const stylesB: Style[] = [
            { name: "max-width", value: "600px", pseudoSelector: null, mediaQuery: null }
        ]
        const firstArtifact: ArtifactTagOpen = {
            artifactType: "TAG_OPEN",
            tagName: "div",
    ...
    test("emits distinct style blocks for different CSS (different pseduo-selectors)", () => {
        const renderer = new DocumentArtifactRenderer()
        const stylesA: Style[] = [
            { name: "max-width", value: "500px", pseudoSelector: ":hover", mediaQuery: null }
        ]
        const stylesB: Style[] = [
            { name: "max-width", value: "600px", pseudoSelector: null, mediaQuery: null }
        ]
    ...
    test("emits distinct style blocks for different CSS (different media queries)", () => {
        ...
        const stylesB: Style[] = [
            { name: "max-width", value: "500px", pseudoSelector: null, mediaQuery: "@media (min-width: 601px)" }
        ]
        const firstArtifact: ArtifactTagOpen = {
            artifactType: "TAG_OPEN",
            tagName: "div",
